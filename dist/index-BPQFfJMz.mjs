import { VToolbar, VSpacer, VDivider, VCard, VCardText, VIcon, VInput, VCardTitle, VBtn, VTooltip, VMenu, VList, VListItem, VListItemTitle } from "vuetify/components";
      ...
      createVNode(_component_v_menu, {
        ...
        default: withCtx(() => [
          createVNode(_component_v_list, {
            ...
            default: withCtx(() => [
              (openBlock(true), createElementBlock(Fragment$1, null, renderList($props.items, (item, i) => {
...
const OlotapPlugin = {
  async install(app, config = {}) {
    ...
    const Extensions = await import("./index-B48Yqtvr.mjs");
...
//# sourceMappingURL=index-BPQFfJMz.mjs.map
