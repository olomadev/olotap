import { VToolbar, VSpacer, VDivider, VCard, VCardText, VIcon, VInput, VCardTitle, VBtn, VTooltip } from "vuetify/components";
import { defineComponent, ref, onMounted, onBeforeUnmount, h, getCurrentInstance, watchEffect, nextTick, unref, markRaw, customRef, provide, reactive, render as render$1, computed, watch, hasInjectionContext, inject, getCurrentScope, onScopeDispose, createBlock, openBlock, mergeProps, withCtx, createElementBlock, Fragment as Fragment$1, renderList, createCommentVNode, resolveDynamicComponent, createSlots, resolveComponent, withDirectives, createVNode, vShow, withModifiers, normalizeClass, renderSlot, createTextVNode, toDisplayString, normalizeProps, guardReactiveProps, normalizeStyle } from "vue";
...
function setBlockType(nodeType, attrs = null) {
  return function(state2, dispatch) {
    ...
    for (let i = 0; i < state2.selection.ranges.length && !applicable; i++) {
      let { $from: { pos: from }, $to: { pos: to } } = state2.selection.ranges[i];
      ...
      (openBlock(true), createElementBlock(Fragment$1, null, renderList($options.items, (item, key) => {
        ...
        return openBlock(), createElementBlock(Fragment$1, { key }, [
          ...
          (openBlock(), createBlock(resolveDynamicComponent(item.button.component), mergeProps({ ref_for: true }, item.button.componentProps, {
            ...
            renderList(item.button.componentSlots, (element, slotName, i) => {
              return {
                name: `${slotName}`,
                fn: withCtx((values) => [
...
const TipTapToolbar = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$6]]);
const _sfc_main$5 = {
  props: {
    editor: {
      type: Object,
                  ...
                  (openBlock(true), createElementBlock(Fragment$1, null, renderList($options.items, (item, key) => {
                    ...
                    return openBlock(), createElementBlock(Fragment$1, { key }, [
                      item.type === "divider" ? (openBlock(), createBlock(_component_v_divider, {
                        ...
                        renderList(item.componentSlots, (element, slotName, i) => {
                          return {
                            name: `${slotName}`,
                            fn: withCtx((values) => [
                              (openBlock(), createBlock(resolveDynamicComponent(element), mergeProps({ ref_for: true }, values == null ? void 0 : values.props), null, 16))
...
const BubbleMenu = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$5]]);
...
const MenuButton = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4]]);
const _sfc_main$3 = {
  computed: {
    getClass() {
...
const MenuItem = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3]]);
const _sfc_main$2 = {
  props: {
    icon: {
      type: String
...
const MenuDropdownButton = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2]]);
const _sfc_main$1 = {
  name: "OlotapEditor",
  components: {
    EditorContent,
...
const OlotapEditor = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1]]);
const _sfc_main = {
  props: {
    icon: {
      type: String,
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_v_icon = VIcon;
  const _component_v_tooltip = VTooltip;
...
const OlotapPlugin = {
  async install(app, config = {}) {
    ...
    const Extensions = await import("./index-CY7TAwhD.mjs");
...
export {
  isNodeSelection as $,
  ActionButton as A,
  getChangedRanges as B,
  findChildrenInRange as C,
  DecorationSet as D,
  Extension as E,
  Fragment as F,
  getMarksBetween as G,
  getAttributes as H,
  isValidURL as I,
  nodeInputRule as J,
  useProvideOlotapStore as K,
  throttle as L,
  Mark2 as M,
  Node2 as N,
  clamp as O,
  Plugin as P,
  NodeViewWrapper as Q,
  nodeViewProps as R,
  Slice as S,
  TextSelection as T,
  isNumber as U,
  ...
  SelectionRange as W,
  Transform as X,
  findParentNodeClosestToPos as Y,
  isMobile as Z,
  _export_sfc as _,
  toArray as a,
  findChildren as a0,
  ...
  useContext as u,
  getCssUnitWithDefault as v,
  watchImmediate as w,
  useOlotapStore as x,
  wrappingInputRule as y,
  combineTransactionSteps as z
};
//# sourceMappingURL=index-Bduooryt.mjs.map
